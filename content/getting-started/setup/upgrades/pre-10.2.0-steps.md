---
uid: setup-upgrades-pre-10.2.0
locale: en
title: DNN Platform Upgrades (Pre 10.2.0)
dnnversion: 09.04.03
---

# DNN Platform Upgrades (Pre 10.2.0)
Following are the basic steps for upgrading **DNN Platform** versions prior to 10.2.0.
